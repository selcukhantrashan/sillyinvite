...
client.on('message', async msg => {
  ...
  // DOLDURULACAK YERLER
  let destekkanal = 'id' // Bir şey yazınca talep açacak kanalın ID
  let destekrol = 'id' // Açılan kanala müdahale edebilecek destek ekibinin rol ID
  let kategori = 'id' // Açılan kanalın yerleştirileceği kategori ID
  // DOLDURULACAK YERLER
